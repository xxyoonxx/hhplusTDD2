...
public class LectureDetailRepositoryImpl implements LectureDetailRepository {
    ...
    @Override
    public LectureDetail findLectureDetailIdWithPessimisticLock(long lectureDetailId) {
        LectureDetailEntity lectureDetailEntity = lectureDetailJpaRepository.findLectureDetailIdWithPessimisticLock(lectureDetailId);
        LectureDetail lectureDetail = lectureDetailEntity.toDomain();
